...
import { lessons } from '@/lib/lessons/pensions-and-your-future'
...
const COURSE_SLUG = 'pensions-and-your-future'
      ...
      <div className="container">
        <div className="course-body">
          <div className="course-body__main">
            ...
            <CourseCurriculum lessons={lessons} totalLabel="5 lessons · all unlocked" courseSlug={COURSE_SLUG} completedSlugs={completedSlugs} />
            <CourseFaq     faqs={faqs} />
