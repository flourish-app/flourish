          ...
          <div className="course-body__main">
            ...
            <div className="course-section">
              ...
              <p className="course-section__sub">
                Lesson 1 is free to preview. Create a free account to unlock all 8 lessons.
              </p>
              ...
              <div className="course-cta-block__inner">
                <div className="course-cta-block__left">
                  ...
                  <p className="course-cta-block__sub">
                    Every year you wait costs more than you think. Create a free account and start Lesson 1 in the next two minutes.
                  </p>
                </div>
