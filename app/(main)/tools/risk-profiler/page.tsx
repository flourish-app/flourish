...
const PROFILES: ProfileDef[] = [
  {
    name: 'Conservative',
    emoji: '🛡️',
    tagline: 'Capital protection is your priority',
    ...
    tips: [
      'Cash ISAs and premium bonds suit your profile well',
      'Government bond funds offer slightly better returns than cash with limited downside',
      'As your circumstances change, your risk profile can too — revisit it annually',
    ],
    courses: [
  ...
  },
  {
    name: 'Cautious',
    emoji: '⚖️',
    tagline: 'Stability with a little growth on the side',
    ...
    tips: [
      'A cautious or balanced fund inside a Stocks & Shares ISA fits your profile well',
      'Diversified bond funds add stability without giving up all growth potential',
      'Time in the market typically reduces risk — even for cautious investors',
    ],
    courses: [
      { href: '/courses/isas-and-tax-free-saving', emoji: '🏦', title: 'ISAs & Tax-Free Saving', meta: '6 lessons · Free' },
  ...
  },
  {
    ...
    tips: [
      'Low-cost global index funds are a great fit for your balanced profile',
      'A Stocks & Shares ISA means all your growth is completely tax-free',
      'Stay the course during downturns — time in the market is your biggest advantage',
    ],
    courses: [
      { href: '/courses/stocks-etfs-and-funds',  emoji: '📊', title: 'Stocks, ETFs & Funds',  meta: '10 lessons · Free' },
      { href: '/courses/investing-from-scratch', emoji: '🚀', title: 'Investing from Scratch', meta: '8 lessons · Free' },
  ...
  },
  {
    ...
    tips: [
      'Global equity index funds and ETFs maximise your long-term growth potential',
      'Filling your ISA allowance every year keeps all gains completely tax-free',
      'Regular monthly investing smooths out market timing and builds discipline',
    ],
    courses: [
      { href: '/courses/stocks-etfs-and-funds',    emoji: '📊', title: 'Stocks, ETFs & Funds',    meta: '10 lessons · Free' },
            ...
            {!done ? (
              ...
              <div className="risk-card">
                ...
                <div className="risk-progress">
                  ...
                  <span className="risk-progress__label">
                ...
                <div className="risk-options">
                  {currentQ.options.map((opt, i) => (
                    <button
                      key={i}
                      className={`risk-option${currentAnswer === i ? ' risk-option--selected' : ''}`}
                      onClick={() => select(i)}
                    >
                      <div className="risk-option__check">
                        {currentAnswer === i && '✓'}
                      </div>
              ...
              <div className="risk-result">
                ...
                <div className="risk-score-track">
                  ...
                  <div className="risk-score-track__bar">
                    <div
                      className="risk-score-track__marker"
                      style={{ left: `clamp(10px, ${scorePct}%, calc(100% - 10px))` }}
                    />
                  </div>
                </div>
                ...
                <div className="risk-alloc">
                  ...
                  <div className="risk-alloc__legend">
                    <span>
                      <span className="risk-alloc__dot" style={{ background: 'var(--green)' }} />
                      Equities {profile.equities}%
                    </span>
                    <span>
                      <span className="risk-alloc__dot" style={{ background: 'var(--grey-3)' }} />
                      Bonds {profile.bonds}%
                    </span>
                    <span>
                      <span className="risk-alloc__dot" style={{ background: 'var(--grey-2)', border: '1px solid var(--grey-3)' }} />
                      Cash {profile.cash}%
                    </span>
                  </div>
                ...
                <div className="risk-tips">
                  ...
                  <ul className="risk-tips__list">
                    {profile.tips.map((tip, i) => (
                      <li key={i} className="risk-tips__item">
                        <span className="risk-tips__dot" />
                        {tip}
                      </li>
                    ))}
                  </ul>
                ...
                <button className="risk-retake" onClick={retake}>
                  ↺ Retake the quiz
                </button>
                  ...
                  <div className="tool-signup-prompt__courses">
                    {signupContent.courses.map(c => (
                      <Link key={c.href} href={c.href} className="tool-prompt-course">
                        <span>{c.emoji}</span>
                        <div>
                          <div className="tool-prompt-course__title">{c.title}</div>
                          <div className="tool-prompt-course__meta">{c.meta}</div>
                        </div>
