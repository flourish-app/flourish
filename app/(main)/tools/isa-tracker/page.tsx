...
const pctOfAllowance = (n: number) =>
  `${Math.round((n / ANNUAL_ALLOWANCE) * 100)}%`
...
// ── ISASlider — defined OUTSIDE page so React never remounts it ──
function ISASlider({
...
export default function ISATrackerPage() {
  ...
  // Each slider can go up to its current value + shared remaining, capped by type limits
  ...
  // Stacked bar widths (% of total allowance)
          ...
          <div className="calc-layout">
            ...
            <div className="calc-inputs">
              ...
              <ISASlider
                label="Cash ISA"
                emoji="💰"
                desc="Savings interest, tax-free"
                value={cash}
                setValue={setCash}
                sliderMax={cashMax}
              />
              <ISASlider
                ...
                emoji="📈"
                desc="Investment growth &amp; dividends, tax-free"
                value={stocks}
                setValue={setStocks}
                sliderMax={stocksMax}
              />
              <ISASlider
                ...
                emoji="🏡"
                desc={`Max £4,000/year · 25% government bonus`}
                value={lisa}
                setValue={setLisa}
                sliderMax={lisaMax}
              />
              <ISASlider
                ...
                emoji="🔗"
                desc="Peer-to-peer lending returns, tax-free"
                value={ifisa}
                setValue={setIfisa}
                sliderMax={ifisaMax}
              />
            ...
            <div className="calc-results">
              ...
              <div className="calc-summary">
                <div className="calc-summary__main">
                  ...
                  <div className="calc-summary__value">
                    {fmt(remaining)}
                  </div>
              ...
              <div className="isa-breakdown">
                ...
                {breakdown.map(row => (
                  <div
                    key={row.label}
                    className={`isa-breakdown__row${row.value === 0 ? ' isa-breakdown__row--empty' : ''}`}
                  >
              ...
              {remaining > 0 && total > 0 && (
                <div className="calc-insight">
                  ...
                  <p>
                    ...
                    of tax-free allowance left this year. Unused allowance doesn&apos;t roll over — it disappears on 5 April.
                  </p>
                </div>
              )}
