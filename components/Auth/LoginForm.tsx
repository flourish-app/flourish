...
export default function LoginForm() {
  ...
  return (
    <div className="auth-card">
      ...
      <div className="auth-card__divider"><span>New to Flourish?</span></div>
      <Link href="/signup" className="btn btn--outline btn--lg auth-signup-btn">Create a free account</Link>
    </div>
  )
}
